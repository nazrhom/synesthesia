...
var R_NORMALIZER = new Normalizer(25, 255, {
  stabilization_rate: 500
})
var G_NORMALIZER = new Normalizer(25, 255, {
  stabilization_rate: 500
})
var B_NORMALIZER = new Normalizer(25, 255, {
  stabilization_rate: 500
})

var R1_NORMALIZER = new Normalizer(25, 255, {
  stabilization_rate: 50000,
  old: false
})
var G1_NORMALIZER = new Normalizer(25, 255, {
  stabilization_rate: 50000,
  old: false
})
var B1_NORMALIZER = new Normalizer(25, 255, {
  stabilization_rate: 50000,
  old: false
})

var R2_NORMALIZER = new Normalizer(25, 255, {
  stabilization_rate: 500
})
var G2_NORMALIZER = new Normalizer(25, 255, {
  stabilization_rate: 500
})
var B2_NORMALIZER = new Normalizer(25, 255, {
  stabilization_rate: 500
})

var R3_NORMALIZER = new Normalizer(25, 255, {
  stabilization_rate: 50000,
  old: false
})
var G3_NORMALIZER = new Normalizer(25, 255, {
  stabilization_rate: 50000,
  old: false
})
var B3_NORMALIZER = new Normalizer(25, 255, {
  stabilization_rate: 50000,
  old: false
})
...
function play(buffer, buffer2, time) {
  ...
  source2.connect(analyser3)
  analyser3.connect(analyser4)
  analyser4.connect(context.destination)
  ...
  gatherData2(analyser3, analyser4)
...
function gatherData(analyser, analyser2) {
  ...
  // Sub-bass 20-60 Hz
  // Bass 60-250 Hz
  var first = freqs.subarray(1, 7)

  // Low Midrange 250-500 Hz
  // Midrange 500-2000 Hz
  var second = freqs.subarray(7, 48)
    // Upper Midrange 2-4 kHz
    // Presence and Brillance 4-20 kHz
  var third = freqs.subarray(48, freqs.length - 1)
...
function gatherData2(analyser, analyser2) {
  analyser.smoothingTimeConstant = SMOOTHING
  analyser.fftSize = FFT_SIZE
  ...
  var R2 = R2_NORMALIZER.getNormalizedAverage(first)
  var G2 = G2_NORMALIZER.getNormalizedAverage(second)
  var B2 = B2_NORMALIZER.getNormalizedAverage(third)

  var R3 = R3_NORMALIZER.getNormalizedAverage(first2)
  var G3 = G3_NORMALIZER.getNormalizedAverage(second2)
  var B3 = B3_NORMALIZER.getNormalizedAverage(third2)

  //  console.log('R ' + R + ' G ' + G + ' B ' + B)
  // console.log('H ' + H + ' S ' + S + ' L ' + L)

  box3.style.background = '#' + rgbToHex(R2, G2, B2)
  box4.style.background = '#' + rgbToHex(R3, G3, B3)
  ...
  // }, 1000 / 100)
  window.requestAnimationFrame(function () {
    return gatherData2(analyser, analyser2)
  })
}
...
loadFile('Chopin.ogg', function (buffer) {
  loadFile('Shempi.ogg', function (buffer2) {
    play(buffer, buffer2, 0)
  })
})
